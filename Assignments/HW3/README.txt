...
2.1 How long does it take (on average) to ping for each case?
Answer
...
2.2 What is the minimum and maximum ping you have observed?
Answer
...
2.3 What is the difference, and why?
Answer
...
3.2 What is the throughput for each case?
Answer
...
3.3 What is the difference, and explain the reasons for the difference.
Answer
...
2.1 How long did it take (on average) to ping for each case?
Answer
...
2.3 Any difference from Task 2, and why do you think there is a change if there is?
Answer
...
3.1 What is the throughput for each case?
Answer
...
3.2 What is the difference from Task 2 and why do you think there is a change if there is?
Answer
